                ...
                <div class="profile__content">
                  ...
                  <div class="profile__textBox">
                    ...
                    <p class="profile__text">
                      ...
                      職務内容としてはdodaのガイドライン運用や派遣時も行っていたコーディング業務全般、業務効率化の為の社内向けギミックガイドライン（プラグインなど用はサイト内のアニメーションなどコピペで使えるようにしたもの）の作成やHTMLメールの業務改善の為の社内ツール（クリックしたらHTMLのパーツが追加されていくような<a href="https://hiromiyablog.com/test/test_01.html" target="_blank">こちら</a>を元に提案し改良したもの）を作成してに提案したり、doda転職フェアなどで使われていた<a href="https://doda.jp/fair/egogram/" target="_blank">エゴグラム適職診断</a>をバックエンドエンジニアと作成（jQueryを独学で初めて実は2作品目くらいのレベル感で作成）するなどし、所属部署内で初のフロントエンドチームというものをゼネラルマネージャーと立ち上げ１年くらい名ばかりな感じでしたが（笑）チームリーダーをしておりました。<br><br>
                      その後、初の所属部署内でのフロントエンドグループの初期立ち上げメンバーとしてフロントエンドグループに所属し、doda全般におけるフロントエンド領域の業務、グループ内の課題・工数管理、ABテストツールを使ってのABテストの作成、エンジニアグループのバックエンドエンジニアとの共同制作等をし、良い経験と実績を積ませて頂いており、<a href="https://www.persol-career.co.jp/" target="_blank">パーソルキャリア株式会社様</a>には今でも感謝しております！<br><br>
                    </p>
